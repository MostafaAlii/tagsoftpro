 ...
 * 📌 MAIN FUNCTIONS: Bulk Actions (الإجراءات الجماعية)
 * ============================================================
 * 
 * 📋 WHAT THIS FILE DOES:
 * ──────────────────────────────────────────────────────────────
 * 1. 📊 Bulk Status Change   - تغيير حالة مجموعة من الصلاحيات
 * 2. 🗑️ Bulk Delete          - حذف ناعم لمجموعة
 * 3. ♻️ Bulk Restore         - استعادة مجموعة محذوفة
 * 4. 💥 Bulk Force Delete    - حذف نهائي لمجموعة
 * 
 * 📦 EXPOSED TO GLOBAL:
 * ──────────────────────────────────────────────────────────────
...
// ─── دالة جلب أسماء المجموعات المختارة ──────────────────
function getSelectedGroupNames(checkboxes) {
    const names = [];
...
function openBulkStatusModal() {
    ...
    const groupNames = getSelectedGroupNames(checkboxes);
    ...
    document.getElementById("bulkActionEmployeeList").innerHTML = groupNames;
...
function openBulkRestoreModal() {
    ...
    document.getElementById("bulkActionMessage").textContent =
        ...
        "هل أنت متأكد من استعادة المجموعات المختارة؟";
    document.getElementById("bulkStatusDropdown").style.display = "none";
    document.getElementById("bulkActionEmployeeList").innerHTML = groupNames;
    ...
    try {
        ...
        if (data?.success) {
            ...
            if (
                ...
                window.LaravelDataTables["permission_groups_datatable"]
            ) {
