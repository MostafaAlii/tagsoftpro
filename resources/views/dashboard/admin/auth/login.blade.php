...
<div class="m-0 authentication-inner row">
    <div class="p-0 d-none d-lg-block col-lg-7 col-xl-8 img-side">
        <img class="img-fluid" width="100%" src="{{ asset('dashboard/themes/'. $theme_code .'/assets/images/auth/using-laptop-gray-wall.jpg') }}" alt="happy young woman sitting on the floor using laptop on gray wall">
    </div>
