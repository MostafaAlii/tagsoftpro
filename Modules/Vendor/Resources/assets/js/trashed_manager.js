 ...
 * 📌 MAIN FUNCTIONS: Trashed Vendors Management
 * ============================================================
 */
...
function buildBulkActionsHTML() {
    let html = `
        <button class="dt-button buttons-collection btn btn-warning" tabindex="0" aria-controls="vendors_datatable" type="button" id="bulkActionsBtn">
            <span>
