 ...
 * 📌 MAIN FUNCTIONS: Trashed Providers Management
 * ============================================================
 */
        ...
        .then((data) => {
            ...
            if (data.hasTrashed) {
                ...
                if (window.showTrashed) {
                    ...
                    const table =
                        window.LaravelDataTables["providers_datatable"];
                    table.ajax
...
function buildBulkActionsHTML() {
    let html = `
        <button class="dt-button buttons-collection btn btn-warning" tabindex="0" aria-controls="providers_datatable" type="button" id="bulkActionsBtn">
            <span>
...
document
    ...
    ?.addEventListener("click", function () {
        ...
        const btnText = document.getElementById("trashedBtnText");
        const table = window.LaravelDataTables["providers_datatable"];
        if (window.showTrashed) {
