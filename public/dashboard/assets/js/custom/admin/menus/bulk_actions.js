...
// ─── دالة جلب أسماء القوائم المختارة ──────────────────
function getSelectedMenuNames(checkboxes) {
    const names = [];
...
function openBulkStatusModal() {
    ...
    const menuNames = getSelectedMenuNames(checkboxes);
    ...
    document.getElementById("bulkActionEmployeeList").innerHTML = menuNames;
...
function openBulkRestoreModal() {
    ...
    document.getElementById("bulkActionMessage").textContent =
        ...
        "هل أنت متأكد من استعادة القوائم المختارة؟";
    document.getElementById("bulkStatusDropdown").style.display = "none";
    document.getElementById("bulkActionEmployeeList").innerHTML = menuNames;
    ...
    try {
        ...
        if (data?.success) {
            ...
            if (
                ...
                window.LaravelDataTables["menus_datatable"]
            ) {
