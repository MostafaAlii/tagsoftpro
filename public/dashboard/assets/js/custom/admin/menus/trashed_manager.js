 ...
 * 📌 MAIN FUNCTIONS: Trashed Menus Management
 * ============================================================
 */
...
function buildBulkActionsHTML() {
    let html = `
        <button class="dt-button buttons-collection btn btn-warning" tabindex="0" aria-controls="menus_datatable" type="button" id="bulkActionsBtn">
            <span>
...
document
    ...
    ?.addEventListener("click", function () {
        ...
        const btnText = document.getElementById("trashedBtnText");
        const table = window.LaravelDataTables["menus_datatable"];
        if (window.showTrashed) {
