 ...
 * 📌 MAIN FUNCTIONS: Trashed Groups Management
 * ============================================================
 */
...
function buildBulkActionsHTML() {
    let html = `
        <button class="dt-button buttons-collection btn btn-warning" tabindex="0" aria-controls="permission_groups_datatable" type="button" id="bulkActionsBtn">
            <span>
...
document
    ...
    ?.addEventListener("click", function () {
        ...
        const btnText = document.getElementById("trashedBtnText");
        const table = window.LaravelDataTables["permission_groups_datatable"];
        if (window.showTrashed) {
