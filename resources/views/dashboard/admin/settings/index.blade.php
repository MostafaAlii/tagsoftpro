                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="system_status" data-toggle="switchbutton" data-size="sm"
                                    ...
                                    data-offlabel="{{ trans('dashboard/general.in_active') }}" data-onstyle="success"
                                    data-offstyle="danger"
                                    value="{{ \App\Enums\MainSetting\MainSettingSystemStatus::SYSTEM_STATUS_ACTIVE->value }}"
                                    @checked( old( 'system_status' , $setting->system_status?->value
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <select name="theme_id" class="form-control select2">
                                        ...
                                        <option value="{{ $theme->id }}" @selected(old('theme_id', $setting?->theme_id)
                                            == $theme->id)>
                                            {{ $theme->name }}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="p-3 mb-3 text-center border rounded">
                                        ...
                                        <input class="form-control" type="file" name="logo" id="logoInput"
                                            accept="image/*">
                                        <img src="{{$logo}}" id="logoPreview" class="img-fluid"
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 mb-3 text-center border rounded">
                                        ...
                                        <input class="form-control" type="file" name="favicon" id="faviconInput"
                                            accept="image/*">
                                        <img src="{{$favicon}}" id="faviconPreview" class="img-fluid"
                                            style="max-height: 60px;" />
                                    </div>
                                </div>
