 ...
 * 📌 MAIN FUNCTIONS: Trashed Zones Management
 * ============================================================
 */
        ...
        .then((data) => {
            ...
            if (data.hasTrashed) {
                ...
                if (window.showTrashed) {
                    ...
                    const table = window.LaravelDataTables["zones_datatable"];
                    table.ajax
...
function buildBulkActionsHTML() {
    let html = `
        <button class="dt-button buttons-collection btn btn-warning" tabindex="0" aria-controls="zones_datatable" type="button" id="bulkActionsBtn">
            <span>
