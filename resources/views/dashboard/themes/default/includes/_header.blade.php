        ...
        <nav class="ms-auto">
            <ul class="header-menu-nav list-unstyled">
                ...
                <li class="hdr-itm dropdown lng-dropdown">
                    <a class="app-head-link dropdown-toggle no-caret" data-bs-toggle="dropdown" href="#" role="button"
                        aria-haspopup="false" aria-expanded="false">
                        <i class="ti ti-world me-1"></i>
                        <span class="drp-text">{{ LaravelLocalization::getSupportedLocales()[app()->getLocale()]['native'] }}</span>
                        ...
                        <ul class="p-0">
                            ...
                            <li class="dropdown-item">
                                <a rel="alternate" hreflang="{{ $localeCode }}"
                                    href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class="drp-link">
                                    {{ $properties['native'] }}
                                </a>
                            </li>
                            @if(!$loop->last)
                ...
                <!-- Start User Menu -->
                @include('dashboard.themes.' . $theme_code . '.includes._user_menu')
                <!-- End User Menu -->
            </ul>
        </nav>
    </div>
