 ...
 * 📌 MAIN FUNCTIONS: Bulk Actions for Providers
 * ============================================================
 */
...
// ─── دالة جلب أسماء مزودي الخدمة المختارة ──────────────────
function getSelectedProviderNames(checkboxes) {
    const names = [];
...
function openBulkStatusModal() {
    ...
    const providerNames = getSelectedProviderNames(checkboxes);
    ...
    if (messageEl) {
        messageEl.innerHTML =
            (window.translations.bulk_restore_confirm ||
                "هل أنت متأكد من استعادة مزودي الخدمة المختارين؟") +
            "<br><br>" +
            providerNames;
    }
    if (statusDropdown) statusDropdown.style.display = "none";
