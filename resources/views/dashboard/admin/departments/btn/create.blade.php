    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ trans('dashboard/departments.create') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <form action="{{ route('admin.departments.store') }}" method="POST" id="createForm">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="mb-3 tab-content">
                        ...
                        <div class="tab-pane fade {{ $locale === $currentLocale ? 'show active' : '' }}"
                            ...
                            <div class="mb-3">
                                <label class="form-label">{{ trans('dashboard/departments.name') }} ({{
                                    strtoupper($locale) }}) <span class="text-danger">*</span></label>
                                <input type="text" name="name[{{ $locale }}]" class="form-control" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">{{ trans('dashboard/departments.description') }} ({{
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="company_id" class="form-select">
                                    <option value="">{{ trans('dashboard/departments.select_company') }}</option>
                    ...
                    <div class="mb-3 d-flex align-items-center justify-content-between">
                        <label class="mb-0 form-label">{{ trans('dashboard/departments.status') }}</label>
