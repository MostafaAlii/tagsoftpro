...
{{-- EDIT MODAL --}}
{{-- ============================= --}}
<div class="modal fade" id="editProjectTypeModal" tabindex="-1" aria-labelledby="editProjectTypeModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="editProjectTypeModalLabel">
                    ...
                    {{ trans('dashboard/project_types.edit') }}
                </h5>
            ...
            <div class="modal-body">
                ...
                {{-- Form --}}
                <form id="editProjectTypeForm" class="d-none">
                    @csrf
                    <input type="hidden" id="editProjectTypeId">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label fw-semibold">
                                {{ trans('dashboard/project_types.name') }} <span class="text-danger">*</span>
                            </label>
                                ...
                                <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}"
                                    ...
                                    <div class="mb-2">
                                        <input type="text" class="form-control" name="name[{{ $locale }}]"
                                            ...
                                            placeholder="{{ trans('dashboard/project_types.name') }} ({{ strtoupper($locale) }})">
                                    </div>
                                    <div>
                                        <textarea class="form-control" name="description[{{ $locale }}]"
                                            id="edit_description_{{ $locale }}" rows="2"
                                            placeholder="{{ trans('dashboard/project_types.description') }} ({{ strtoupper($locale) }})"></textarea>
                                    </div>
                                </div>
                                @endforeach
                            </div>
                        ...
                        @ownerOnly
                        <div class="col-md-12">
                            <label class="form-label">{{ trans('dashboard/project_types.company') }}</label>
                        ...
                        {{-- Status --}}
                        <div class="col-md-12">
                            <label class="form-label d-block">{{ trans('dashboard/project_types.status') }}</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="saveEditProjectType">
...
{{-- DELETE MODAL --}}
{{-- ============================= --}}
<div class="modal fade" id="deleteProjectTypeModal" tabindex="-1" aria-labelledby="deleteProjectTypeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center border-0 pt-2">
                <input type="hidden" id="deleteProjectTypeId">
                <button type="button" class="btn btn-secondary px-4" data-bs-dismiss="modal">
                    {{ trans('dashboard/general.cancel') }}
                </button>
                <button type="button" class="btn btn-danger px-4" id="confirmDeleteProjectType">
                    <span class="indicator-label">
