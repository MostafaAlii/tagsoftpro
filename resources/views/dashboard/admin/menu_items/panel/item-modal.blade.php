<div class="modal fade" id="panelItemModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="ti ti-edit me-2"></i>
                    <span id="panelItemModalTitle">{{ trans('dashboard/menu_items.create') }}</span>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <div id="panelItemModalLoader" class="py-5 text-center d-none">
                    <div class="spinner-border text-primary" role="status"></div>
                </div>
                <form id="panelItemForm">
                    @csrf
                    <input type="hidden" id="panel_item_id" value="">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="type" id="panel_type" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group icon-picker-group">
                                    <span class="input-group-text" id="panel_icon_preview">
                                        <i class="ti ti-users"></i>
                                    </span>
                                    <select class="form-select icon-picker-select" name="icon" id="panel_icon"
                                        data-preview="#panel_icon_preview">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="link_type" id="panel_link_type">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="route_name" id="panel_route_name"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="url" id="panel_url"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="target" id="panel_target">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label">{{ trans('dashboard/menu_items.status') }} <span
                                        class="text-danger">*</span></label>
                                <select class="form-select" name="status" id="panel_status" required>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="is_owner_only" id="panel_is_owner_only">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="permission_name"
                                    id="panel_permission_name" placeholder="view_dashboard">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="badge_text" id="panel_badge_text"
                                    placeholder="New">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="badge_color" id="panel_badge_color">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="company_id" id="panel_company_id">
                                    <option value="">-- {{ trans('dashboard/general.select') }} --</option>
                                    ...
                                    <ul class="nav nav-tabs w-100" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link {{ $index === 0 ? 'active' : '' }}"
                                                data-bs-toggle="tab" data-bs-target="#panel-lang-{{ $locale }}"
                                                type="button">
                                                {{ strtoupper($locale) }} <span class="text-danger">*</span>
                                            </button>
                                        </li>
                                        @endforeach
                                    </ul>
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}"
                                            id="panel-lang-{{ $locale }}">
                                            <div class="mb-3">
                                                <label class="form-label">{{ trans('dashboard/menu_items.title') }}
                                                    <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control"
                                                    name="locales[{{ $locale }}][title]"
                                                    id="panel_locales_{{ $locale }}_title" @if($locale=='ar' ) required
                                                    @endif>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">{{ trans('dashboard/menu_items.description')
                                                    }}</label>
                                                <textarea class="form-control"
                                                    name="locales[{{ $locale }}][description]"
                                                    id="panel_locales_{{ $locale }}_description" rows="3"></textarea>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="panelItemSaveBtn">
                    <span class="indicator-label">
                        <i class="ti ti-check me-1"></i>{{ trans('dashboard/general.save') }}
                    </span>
