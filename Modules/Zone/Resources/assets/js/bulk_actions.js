 ...
 * 📌 MAIN FUNCTIONS: Bulk Actions for Zones
 * ============================================================
 */
...
// ─── دالة جلب أسماء المناطق المختارة ──────────────────
function getSelectedZoneNames(checkboxes) {
    const names = [];
...
function openBulkStatusModal() {
    ...
    const zoneNames = getSelectedZoneNames(checkboxes);
    ...
    if (messageEl) {
        messageEl.innerHTML =
            window.translations.bulk_status_confirm + "<br><br>" + zoneNames;
    }
...
function openBulkDeleteModal() {
    ...
    if (messageEl) {
        messageEl.innerHTML =
            window.translations.bulk_delete_confirm + "<br><br>" + zoneNames;
    }
    ...
    if (messageEl) {
        messageEl.innerHTML =
            (window.translations.bulk_restore_confirm ||
                "هل أنت متأكد من استعادة المناطق المختارة؟") +
            "<br><br>" +
            zoneNames;
    }
    if (statusDropdown) statusDropdown.style.display = "none";
    ...
    try {
        ...
        if (data?.success) {
            ...
            if (
                ...
                window.LaravelDataTables["zones_datatable"]
            ) {
                window.LaravelDataTables["zones_datatable"].ajax.reload(
                    null,
                    false,
                );
            }
