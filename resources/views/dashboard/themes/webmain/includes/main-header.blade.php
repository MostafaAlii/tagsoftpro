        ...
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="{{ guard_dashboard_route() }}">
                    <img src="{{ $logo }}" alt="{{ $settings?->company_name }}">
                </a>
                <a class="navbar-brand brand-logo-mini" href="{{ guard_dashboard_route() }}">
                    <img src="{{ $logo }}" alt="{{ $settings?->company_name }}">
                </a>
            </div>
            <!-- Top bar left -->
            ...
            <ul class="nav navbar-nav ml-auto">
                <div class="btn-group mb-1">
                    ...
                    @if (App::getLocale() == 'ar')
                        ...
                        <img src="{{ URL::asset('dashboard/themes/' . $theme_code . '/assets/images/flags/EG.png') }}" alt="">
                    @else
                        {{ LaravelLocalization::getCurrentLocaleName() }}
                        <img src="{{ URL::asset('dashboard/themes/' . $theme_code . '/assets/images/flags/US.png') }}" alt="">
                    @endif
                    </button>
                ...
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="{{ asset('dashboard/themes/'. $theme_code .'/assets/images/profile-avatar.jpg') }}" alt="{{get_user_data()?->name}}">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="dropdown-header">
                            <div class="media">
                                <div class="media-body">
                                    <h5 class="mt-0 mb-0">{{ucfirst(get_user_data()?->name)}}</h5>
                                    <span>
                                        {{ucfirst(get_user_data()?->email)}}
                                    </span>
                                </div>
                            </div>
                        </div>
